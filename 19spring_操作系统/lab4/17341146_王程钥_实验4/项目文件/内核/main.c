...
{
  int i,pre=Intvec,cs_8,ip_8,cs_9,ip_9;
  char p=(pos-1)/18;
...
#define OffSetOfNewInt8 0x9500
#define OffSetOfNewInt9 0x9900
#define OffSetOfNewInt33 0xc500
#define OffSetOfNewInt34 0xc700
#define OffSetOfNewInt35 0xc900
#define OffSetOfNewInt36 0xcb00
void load()
{
  load_int(22,0x33,OffSetOfNewInt33);
  load_int(23,0x34,OffSetOfNewInt34);
  load_int(24,0x35,OffSetOfNewInt35);
  load_int(25,0x36,OffSetOfNewInt36);
}

void set_time()
{
  if(!TIME)load_int(20,0x08,OffSetOfNewInt8);
...
void run_com(char pos,int offset)
{
  int i;char p;
  if(!pos)return;
  if(OUCH)load_int(21,0x09,OffSetOfNewInt9);
