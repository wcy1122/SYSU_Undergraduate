...
int load_com(char pos,int segment,int offset)
{
...
void system_call()
{
  ...
  clear_screen(16,40,21,79);have_run=1;
  puts("  'ouch'   --- show ouch");
...
void start()
{
  ...
  puts("This is wcy1122's OS v4.0");
