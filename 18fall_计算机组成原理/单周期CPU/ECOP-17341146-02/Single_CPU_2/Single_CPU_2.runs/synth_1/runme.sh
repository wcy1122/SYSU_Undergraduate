...
HD_PWD='D:/vivado/Single_CPU_2/Single_CPU_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solve.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solve.tcl
