...
HD_PWD='D:/vivado/Single_CPU_2/Single_CPU_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solve.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solve.tcl -notrace
